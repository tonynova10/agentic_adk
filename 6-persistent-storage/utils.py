...
async def process_agent_response(event):
    ...
    if event.content and event.content.parts:
        for part in event.content.parts:
            ...
            elif hasattr(part, "executable_code") and part.code_execution_result:
    ...
    if event.is_final_response():
        if (
            ...
            print(
                f"\n{Colors.BG_RED}{Colors.WHITE}{Colors.BOLD}==> Final Agent Response: [No text content in final "
                f"event]{Colors.RESET}\n"
            )
